...
<body>
	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5"
					...
					<ul id="sidebarnav">
						...
						<li class="sidebar-item pt-2"><a
							...
							href="dashboard.html" aria-expanded="false"> <i
								...
								class="hide-menu">Emploi de temps</span>
						</a></li>
						<li class="sidebar-item"><a
							class="sidebar-link waves-effect waves-dark sidebar-link"
							href="profile.html" aria-expanded="false"> <i
								class="fa fa-user" aria-hidden="true"></i> <span
								class="hide-menu">Absences</span>
						</a></li>
		...
		<div class="page-wrapper">
						...
						<div class="white-box">
							...
							<div class="d-md-flex">
								<ul class="list-inline d-flex ms-auto">
									<li class="ps-3">
										<h5>
											<i class="fa fa-circle me-1 text-info"></i>Mac
										</h5>
									</li>
									<li class="ps-3">
										<h5>
					...
					<div class="col-md-12 col-lg-8 col-sm-12">
						<div class="card white-box p-0">
							...
							<div class="comment-widgets">
								...
								<div class="d-flex flex-row comment-row p-3">
									<div class="p-2">
										<img src="plugins/images/users/ritesh.jpg" alt="user"
											width="50" class="rounded-circle">
									</div>
									<div class="comment-text ps-2 ps-md-3 w-100">
								...
								<ul class="chatonline">
									...
									<li>
										...
										class="d-flex align-items-center"><img
											...
											class="img-circle">
											<div class="ms-2">
												<span class="text-dark">Genelia Deshmukh <small
									...
									<li>
										...
										class="d-flex align-items-center"><img
											...
											class="img-circle">
											<div class="ms-2">
												<span class="text-dark">Ritesh Deshmukh <small
									...
									<li>
										...
										class="d-flex align-items-center"><img
											...
											class="img-circle">
											<div class="ms-2">
												<span class="text-dark">Arijit Sinh <small
									...
									<li>
										...
										class="d-flex align-items-center"><img
											...
											class="img-circle">
											<div class="ms-2">
												<span class="text-dark">Govinda Star <small
									...
									<li>
										...
										class="d-flex align-items-center"><img
											...
											class="img-circle">
											<div class="ms-2">
												<span class="text-dark">John Abraham<small
													class="d-block text-success">online</small></span>
											</div> </a>
									</li>
								</ul>
			...
			<!-- footer -->
			<!-- ============================================================== -->
			<footer class="footer text-center"> Copyright &copy; 2021 All Rights Reserved by Université Moulay Ismaïl.
            </footer>
			<!-- ============================================================== -->
			<!-- End footer -->
			<!-- ============================================================== -->
	...
	<script src="javaScript/pages/dashboards/dashboard1.js"></script>
</body>
