		...
		<div class="page-wrapper">
			...
			<div class="wrapper wrapper--w960">
				<div class="card card-2">
					...
					<div class="card-body">
						<h2 class="title">Ajout des documents</h2>
						<form action="ajouterDocEtu" method="POST" enctype="multipart/form-data">
							...
							<div class="row row-space">
								...
								<div class="col-2">
									<p class="input--style-2">baccalaureat</p>
									<div class="input-group">
										...
										<div class="rs-select2 js-select-simple select--no-search">
											...
											<input type="file" id="avatar" name="baccalaureat"
												accept=".pdf" placeholder="baccalaureat">
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row row-space">
								<p class="input--style-2">Relevé de note</p>
									<div class="input-group">
										...
										<div class="rs-select2 js-select-simple select--no-search">
											...
											<input type="file" id="avatar" name="relevee de note"
												accept=".pdf" placeholder="relevee de note">
										</div>
									</div>
							</div>
							<div class="p-t-30">
							<input name="idEt" type="hidden" value="${idEt}"/>
