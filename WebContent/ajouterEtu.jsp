...
<div class="page-wrapper">
		...
		<div class="wrapper wrapper--w960">
			<div class="card card-2">
				...
				<div class="card-body">
					<h2 class="title">Inscription etudiant</h2>
					<form action="ServletAjout" method="POST" >
						...
						<div class="row row-space">
							<div class="col-2">
								<div class="input-group">
									<input class="input--style-2" type="text" placeholder="ville"
										name="villeN">
						...
						<div class="input-group">
							<div class="rs-select2 js-select-simple select--no-search">
								<select name="filiere">
									<option disabled="disabled" selected="selected">Filiere choisis</option>
									<option value="BGI">
										BGI</option>
									<option value="BGB">
										BGB</option>
