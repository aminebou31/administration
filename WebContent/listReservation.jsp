	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5"
		...
		<div class="page-wrapper">
			...
			<div class="row">
				...
				<form action="filtrerRes" method="POST"> 
					<div class="col-md-6">
						<div id="example_filter" class="dataTables_filter">
										<label>Search:<input type="search"
											class="form-control input-sm" placeholder="Nom prof" name="nom_prof"
					...
					<div class="col-sm-12">
						<div class="white-box">
							<div id="example_wrapper"
								...
								<h3 class="box-title">Table de reservations</h3>
								<div class="table-responsive">
									<table class="table text-nowrap">
										<thead>
											<tr>
												<th class="border-top-0">#</th>
												<th class="border-top-0">Nom Prof</th>
												<th class="border-top-0">Id Salle</th>
												<th class="border-top-0">Date</th>
												<th class="border-top-0">Creneau</th>
												<!--   <th class="border-top-0"></th>-->
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${listRes}" var="e">
												<tr>
													<td></td>
													<td>${ e.getNom_prof(e.getId_prof())}</td>
													<td>${ e.getId_salle()}</td>
													<td>${ e.getDate_res()}</td>
													<td>${ e.getCrenau()}</td>
													
													<td>
													<a href="deletRes?idProf=<c:out  value='${e.getId_prof()}'/>&idSalle=<c:out  value='${e.getId_salle()}'/>&date_res=<c:out  value='${e.getDate_res()}'/>&crenau=<c:out  value='${e.getCrenau()}'/>" style="margin-right: 16px;"> 
