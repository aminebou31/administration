					...
					<div class="col-sm-12">
						<div class="white-box">
							<div id="example_wrapper"
								...
								<h3 class="box-title">Table de réservations</h3>
										...
										<tbody>
											<c:forEach items="${listRes}" var="e">
												<tr>
													...
													<td>
													<a href="deletResProf?idSalle=<c:out  value='${e.getId_salle()}'/>&date_res=<c:out  value='${e.getDate_res()}'/>&crenau=<c:out  value='${e.getCrenau()}'/>" style="margin-right: 16px;"> 
