		...
		<div class="page-wrapper">
			...
			<div class="row">
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
						...
						<div class="col-sm-12">
						<div class="white-box">
						<form action="listSalleFiltre" method="POST"> 
					<div class="col-md-6">
						...
						<div class="white-box">
							<div id="example_wrapper"
								...
								<a class="sidebar-link waves-effect waves-dark sidebar-link"
									href="ajouterSalle.jsp" aria-expanded="false">
										...
										<tbody>
											<c:forEach items="${listSalle}" var="e">
												<tr>
													...
													<td>${ e.getDescri()}</td>
													<td>
													<a href="reserverSalle?&idSalle=<c:out  value='${e.getId_salle()}'/>&date=<c:out  value='${date}'/>&crenau=<c:out  value='${crenau}'/>" class="edit"> <i
								class=" fas fa-pen-square" aria-hidden="true"></i>Reserver
													</a></td>
													<td>
														<c:url var="urlet" value="editSalle">
															<c:param name="idSalle">${e.getId_salle() }</c:param>
														</c:url> 
														<a href="${urlet}" class="edit"><i
								class=" fas fa-edit" aria-hidden="true"></i>Modifier</a> 

													</td>
													<td><c:url var="urlet" value="deleteSalle">
															<c:param name="idSalle">${e.getId_salle() }</c:param>
