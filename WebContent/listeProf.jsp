	...
	<div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5"
		...
		<div class="page-wrapper">
			...
			<div class="row">
				...
				<form action="filtreProf" method="POST"> 
					<div class="col-md-6">
						<div class="position-relative form-group"> <label for="Matiere" class="">Matiere</label> <select
								id="listmatiere" name="nom_mat" class="form-control">
							...
							<div id="example_wrapper"
								...
								<div class="dt-buttons">
									...
									<a
											...
											tabindex="0" aria-controls="example" href="PDFMakerP"><span>PDF</span></a>
									</div>
									
								</div>
								<div class="clear"></div>
								<h3 class="box-title">Table professeur</h3>

								<a class="sidebar-link waves-effect waves-dark sidebar-link"
									href="ajouterProf" aria-expanded="false">
									<button type="submit" class="button button1">Ajouter
										professeur</button>
								</a> <a class="sidebar-link waves-effect waves-dark sidebar-link"
									href="ajoutEtuExcel.jsp" aria-expanded="false">
									<button type="submit" class="button button1">Ajouter
										liste professeur</button>
								</a>
									...
									<table class="table text-nowrap">
										<thead>
											<tr>
												...
												<th class="border-top-0">NOMBRE D'ABSENCES</th>
												<th class="border-top-0">TEL</th>
											</tr>
										</thead>
										<tbody>
											<c:forEach items="${listProfess}" var="e">
												<tr>
													<td>${ e.getId_prof()}</td>
													<td>${ e.getNom()}</td>
													<td>${ e.getPrenom()}</td>
													<td>${ e.getNbreAbsence()}</td>
													<td>${ e.getTel()}</td>
													
													<td>
														<c:url var="urlet" value="editProf">
															<c:param name="idProfesseur">${e.getId_prof() }</c:param>
														</c:url> 
														<a href="${urlet}" class="edit"><i
								class=" fas fa-edit" aria-hidden="true"></i>Modifier</a> 

													</td>
													<td>
													<c:url var="urlet" value="ajouterDocP">
															<c:param name="idProfesseur">${e.getId_prof() }</c:param>
														</c:url>
								...
								class="fas fa-plus-square" aria-hidden="true"></i>
													...
													<td><c:url var="urlet" value="deleteprof">
															<c:param name="idProfesseur">${e.getId_prof() }</c:param>
