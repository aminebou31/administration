			...
			<form action="modifierEtu" method="post">
					...
					<div class="modal-body">
						<div class="form-group">
							<label>Nom Arabe</label> <input name="nomAr" value="${ infoEtu.getNomAr() }" type="text"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Nom Francais</label> <input name="nomFr" value="${ infoEtu.getNomFr() }" type="text"
								class="form-control" required>
						</div>
						
						<div class="form-group">
							<label>Prenom Arabe</label> <input name="prenomAr" value="${ infoEtu.getPrenomAr() }" type="text"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Prenom Francais</label> <input name="prenomFr" value="${ infoEtu.getPrenomFr() }" type="text"
								class="form-control" required>
						</div>
						<div class="col-md-6">
					...
					<input name="id" type="hidden" value="${id_etu}"/>
