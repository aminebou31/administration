			...
			<form action="modifierProf" method="post">
					...
					<div class="modal-body">
						<div class="form-group">
							<label>Nom</label> <input name="nom" value="${ infoProf.getNom() }" type="text"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Prenom</label> <input name="prenom" value="${ infoProf.getPrenom() }" type="text"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Nombre d'absence</label> <input name="nombre_abs" value="${ infoProf.getNbreAbsence() }" type="text"
								class="form-control" required>
						</div>
						<div class="form-group">
							<label>Numero de telephone</label> <input name="num_tel" value="${ infoProf.getTel() }" type="text"
								class="form-control" required>
						</div>
					</div>
					<div class="modal-footer">
					<input name="id" type="hidden" value="${id_prof}"/>
